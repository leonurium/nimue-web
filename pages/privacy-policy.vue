<template>
    <h1>Privacy Policy for Netijen Curhat</h1>

    <p>At Netijen Curhat, accessible from https://netijencurhat.com, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and recorded by Netijen
        Curhat and how we use it.</p>
    ...
    <p>Netijen Curhat follows a standard procedure of using log files. These files log visitors when they visit websites.
        ...
        movement on the website, and gathering demographic information. Our Privacy Policy was created with the help of the
        <a href="https://www.webterms.org/privacy-policy-generator/">Privacy Policy Generator</a>.
    </p>

    <h2>Cookies and Web Beacons</h2>

    <p>Like any other website, Netijen Curhat uses "cookies". These cookies are used to store information including
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Netijen Curhat.</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on Netijen Curhat, which are sent directly to users' browser.
    ...
    <p>Note that Netijen Curhat has no access to or control over these cookies that are used by third-party advertisers.</p>

    <h2>Third Party Privacy Policies</h2>

    <p>Netijen Curhat's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
    ...
    <p>Netijen Curhat does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to
        the information that they shared and/or collect in Netijen Curhat. This policy is not applicable to any information
