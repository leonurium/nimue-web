<template>
    <div class="flex flex-col h-full overflow-auto gap-5 p-6">
        ...
        <p>Google is one of a third-party vendor on our
            ...
            sites on the internet. However, visitors may
            choose to decline the use of DART cookies by
        ...
        <p>Third-party ad servers or ad networks uses
            ...
            Curhat, which are sent directly to users'
            browser. They automatically receive your IP
            address when this occurs. These technologies are
